...
public class MicrosoftService {
    ...
    public MicrosoftSession authenticate() throws AuthenticationException {
        try {
            // Используем стандартные 2 параметра, чтобы не было ошибки компиляции
    ...
    public MicrosoftSession refresh(MicrosoftSession oldSession) throws AuthenticationException {
        try {
            // Используем стандартные 2 параметра
    ...
    private static class MinecraftStoreResponse extends MicrosoftErrorResponse {
